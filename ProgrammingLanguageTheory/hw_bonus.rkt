...
(parse '{if0 {- x 198} x {+ x x}})

(test (run '{{fun {x} {if0 {- x 198} x {+ x x}}} {{fun {y} {with {z 3} {{fun {s} {+ {+ s z} y}} 0}}} 1}} (mtSub) (mtSto)) (numV 8)) 
(test (run '{{fun {x} x} {fun {y} {with {z 3} {{fun {s} s} 0}}}} (mtSub) (mtSto)) (closureV 'y (app (fun 'z (app (fun 's (id 's)) (num 0))) (num 3)) (mtSub))) 
(test (run '{{fun {x} 0} {+ {fun {z} 3} {fun {y} {fun {o} 2}}}} (mtSub) (mtSto)) (numV 0)) 
(test (run '{{fun {x} {+ 3 5}} {+ {fun {z} 3} {fun {y} {fun {o} 2}}}} (mtSub) (mtSto)) (numV 8))