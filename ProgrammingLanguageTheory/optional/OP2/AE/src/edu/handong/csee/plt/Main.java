/*
	...
	cd C:\Users\wonsik\"OneDrive - handong.edu"\ univ\2019_2\ProgrammingLanguageTheory\hw\optional\OP2\AE\src

	1. cd [your path]\AE\src  
...
public class Main {
	...
	public static void main(String[] args) {
		if(args.length == 0) {
			System.out.println("There is no AE");
			return;
		}
