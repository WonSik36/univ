/*
	...
	cd C:\Users\wonsik\"OneDrive - handong.edu"\ univ\2019_2\ProgrammingLanguageTheory\hw\optional\OP2\FWAE\src

	1. cd [your path]\FWAE\src  
...
public class Main {
	...
	public static void main(String[] args) {
		if(args.length == 0) {
			System.out.println("There is no FWAE");
			return;
		}
		...
		try {
			...
			if(onlyParser) {
				...
				String result = interpreter.interp(ast).getASTCode();
