...
public class Test {
	...
	public static void main(String[] args) {
		...
		assertThat("{with {x 3} {with {f {fun {y} {+ x y}}} {with {x 5} {f 4}}}}"
				, "(v*s (numV 7) (aSto 4 (numV 4) (aSto 3 (numV 5) (aSto 2 (closureV y (add (id x) (id y)) (aSub x 1 (mtSub))) (aSto 1 (numV 3) (mtSto))))))",false, false);
		assertThat("{with {y 3}{with {z {fun {x} {+ x y}}} {with {y 10} z}}}"
				, "(v*s (closureV x (add (id x) (id y)) (aSub y 1 (mtSub))) (aSto 3 (numV 10) (aSto 2 (closureV x (add (id x) (id y)) (aSub y 1 (mtSub))) (aSto 1 (numV 3) (mtSto)))))",false, false);
		assertThat("{with {z {fun {x} {+ x y}}} {with {y 10} z}}", 
				"(v*s (closureV x (add (id x) (id y)) (mtSub)) (aSto 2 (numV 10) (aSto 1 (closureV x (add (id x) (id y)) (mtSub)) (mtSto))))",false, false);
		assertThat("{with {z {fun {x} {+ x y}}} {with {y 10}{z 5}}}"
				, "Free Identifier: y",false, true);
		assertThat("{with {f {fun {x} x}} {f 10}}", "(v*s (numV 10) (aSto 2 (numV 10) (aSto 1 (closureV x (id x) (mtSub)) (mtSto))))",false, true);
		
		// recursion test case
		assertThat("{rec {fac {fun {n} {if0 n 1 {* n {fac {- n 1}}}}}} {fac 10}}", 
				"(v*s (numV 3628800) (aSto 12 (numV 0) (aSto 11 (numV 1) (aSto 10 (numV 2) (aSto 9 (numV 3) (aSto 8 (numV 4) (aSto 7 (numV 5) (aSto 6 (numV 6) (aSto 5 (numV 7) (aSto 4 (numV 8) (aSto 3 (numV 9) (aSto 2 (numV 10) (aRecSto 1 (closureV n (if0 (id n) (num 1) (mult (id n) (app (id fac) (sub (id n) (num 1))))) (aSub fac 1 (mtSub))) (mtSto))))))))))))))",false,false);
		...
		assertThat("{rec {sum {fun {n} {if0 n 0 {+ n {sum {- n 1}}}}}} {sum 10}}"
				,"(v*s (numV 55) (aSto 12 (numV 0) (aSto 11 (numV 1) (aSto 10 (numV 2) (aSto 9 (numV 3) (aSto 8 (numV 4) (aSto 7 (numV 5) (aSto 6 (numV 6) (aSto 5 (numV 7) (aSto 4 (numV 8) (aSto 3 (numV 9) (aSto 2 (numV 10) (aRecSto 1 (closureV n (if0 (id n) (num 0) (add (id n) (app (id sum) (sub (id n) (num 1))))) (aSub sum 1 (mtSub))) (mtSto))))))))))))))",false,false);
		
		// variable test case
		assertThat("{with {b {newbox 0}} {seqn {setbox b {+ 1 {openbox b}}} {openbox b}}}","(v*s (numV 1) (aSto 1 (numV 1) (aSto 2 (boxV 1) (aSto 1 (numV 0) (mtSto)))))",false,false);
		assertThat("{with {b {newbox 7}} {seqn {setbox b 10} {openbox b}}}","(v*s (numV 10) (aSto 1 (numV 10) (aSto 2 (boxV 1) (aSto 1 (numV 7) (mtSto)))))",false,false);
		assertThat("{with {b {newbox 7}} {{fun {box} {seqn {setbox box 10} {+ 10 {openbox b}}}} b}}","(v*s (numV 20) (aSto 1 (numV 10) (aSto 3 (boxV 1) (aSto 2 (boxV 1) (aSto 1 (numV 7) (mtSto))))))",false,false);
		assertThat("{with {swap {refun {x} {refun {y} {with {z x} {seqn {setvar x y} {setvar y z}}}}}} {with {a 10} {with {b 20} {seqn {{swap a} b} b}}}}"
		...
		assertThat("{with {swap {fun {x} {fun {y} {with {z x} {seqn {setvar x y} {setvar y z}}}}}} {with {a 10} {with {b 20} {seqn {{swap a} b} b}}}}"
				, "(v*s (numV 20) (aSto 5 (numV 10) (aSto 4 (numV 20) (aSto 6 (numV 10) (aSto 5 (numV 20) (aSto 4 (numV 10) (aSto 3 (numV 20) (aSto 2 (numV 10) (aSto 1 (closureV x (fun y (app (fun z (seqn (setvar x (id y)) (setvar y (id z)))) (id x))) (mtSub)) (mtSto))))))))))",false,false);
	}
